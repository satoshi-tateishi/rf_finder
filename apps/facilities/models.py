...
class Facility(models.Model):
    ...
    applied_area = models.CharField(max_length=255, verbose_name='適用エリア', blank=True, default='')
    # 郵便番号 (住所から自動算出またはCSVインポート)
    postal_code = models.CharField(max_length=100, blank=True, default='', verbose_name='郵便番号')
...
class TVChannelStatus(models.Model):
    ...
    def __str__(self):
        return f'{self.facility.name} - Ch{self.channel_number}'
